...
Daniel Kondziella, MD PhD FEBN Principal investigator of and project developer of CONNECT-ME Neurocentret, Rigshospitalet   
  
**Who funded the creation of the dataset?**  
  
1) Copenhagen University 2) Offerfonden 3) Jens Juhl fonden 4) Rigshospitalets forskningspuljer  
  
**Any other comments?**  
  
All our data are derived from electronic medical records, thus if additional details are needed in the process, we will be able to retrieve these from validated records.  
